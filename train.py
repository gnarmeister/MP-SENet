        ...
        for i, batch in enumerate(train_loader):
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    ...
                    print(
                        "Steps : {:d}, Gen Loss: {:4.3f}, Disc Loss: {:4.3f}, Metric loss: {:4.3f}, Magnitude Loss : {:4.3f}, Phase Loss : {:4.3f}, Complex Loss : {:4.3f}, Time Loss : {:4.3f}, STFT Loss : {:4.3f}, s/b : {:4.3f}".format(
                            steps,
                            loss_gen_all,
                            loss_disc_all,
                            metric_error,
